        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <form role="form" method="POST" action="{{ route('vendor.login.submit') }}">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group text-center login">
                            <div class="col-xs-12 col-md-6 col-md-offset-3" style="margin-top: 10px;">
                                <a href="{{route('vendor.reg')}}" class="text-center">Become a Vendor</a>
                            </div>
                        </div>
                    </form>
...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p>2019 Powered by <strong><a href="{{url('/')}}" target="_blank">{{$settings[0]->title}}</a></strong></p>
            </div>
        </div>
    </div>
</footer>
